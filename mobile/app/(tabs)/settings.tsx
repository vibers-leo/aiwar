...
import { Bell, Volume2, Shield, Info, LogOut, ChevronRight } from "lucide-react-native";
  ...
  return (
    <SafeAreaView edges={["bottom"]} className="flex-1 bg-bg">
      <ScrollView className="flex-1 px-5 pt-4">
        ...
        <Text className="text-text-muted text-xs font-bold uppercase mb-2 ml-1">게임</Text>
        <View className="bg-card rounded-xl border border-border mb-6">
          ...
          <View className="flex-row items-center justify-between p-4">
            <View className="flex-row items-center">
              <Volume2 size={20} color="#00D9FF" />
              <Text className="text-text ml-3">효과음</Text>
            </View>
            <Switch
              value={sound}
