...
export const CARD_DATABASE: CardTemplate[] = [
    ...
    { id: 'common-tone-sampler', imageUrl: '/card_placeholder_1765931222851.png', name: 'Tone Sampler', aiFactionId: 'suno', rarity: 'common', specialty: 'music', cardType: 'normal', description: '오디오 샘플을 수집하는 기초 음향 유닛.', baseStats: { creativity: { min: 15, max: 30 }, accuracy: { min: 15, max: 25 }, speed: { min: 20, max: 35 }, stability: { min: 20, max: 30 }, ethics: { min: 25, max: 35 } } },
    ...
    { id: 'rare-melody-weaver', imageUrl: '/card_placeholder_1765931222851.png', name: 'Melody Weaver', aiFactionId: 'suno', rarity: 'rare', specialty: 'music', cardType: 'normal', description: '멜로디를 생성하고 편곡하는 음악 전문 유닛.', baseStats: { creativity: { min: 45, max: 60 }, accuracy: { min: 30, max: 40 }, speed: { min: 25, max: 35 }, stability: { min: 35, max: 45 }, ethics: { min: 40, max: 50 } } },
